...
variable "is_internal_cluster" {
  description = "Define if the cluster is internal, meaning it will not have public IPs and will not be accessible from the internet."
  type        = bool
  default     = false
}
